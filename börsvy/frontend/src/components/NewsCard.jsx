    ...
    <div className="bg-[#1a1a1a] rounded-xl shadow-sm p-6 border border-[#333333]">
      ...
      <div className="space-y-4">
        {news.map((article, index) => (
          <div key={index} className="flex gap-4 p-4 bg-[#262626] rounded-lg border border-[#333333] hover:bg-[#2a2a2a] transition-colors">
            ...
            <div className="flex-grow">
              <a 
                ...
                className="text-lg font-semibold text-blue-400 hover:text-blue-300 mb-1 block"
              >
                {article.title}
              </a>
